...
export class ErrorHandler {
   ...
   */
  static handle(error: unknown, options: ErrorHandlerOptions = {}): BaseError {
    const {
      showToast = true,
      logError = true,
      rethrow = false,
   ...
   */
  private static showUserNotification(error: BaseError, customMessage?: string): void {
   ...
   */
  static handleSilently(error: unknown): BaseError {
   ...
   */
  static handleWithMessage(error: unknown, message: string): BaseError {
 ...
 */
export function handleApiError(error: unknown, options?: ErrorHandlerOptions): BaseError {
 ...
 */
export function handleApiErrorSilently(error: unknown): BaseError {
